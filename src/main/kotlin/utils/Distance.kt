...
fun<T> WeightedGraph<T, WeightedNode<T>>.distanceBetween(start: WeightedNode<T>, end: WeightedNode<T>): Double = distanceBetween(start, end) { from, to -> from.getWeight(to)!! }
